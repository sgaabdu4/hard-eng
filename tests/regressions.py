...
IN_PROCESS = (
    ...
    CHECKS / "bounded_run_survivors_regression_check.py",
    CHECKS / "bounded_run_survivors2_regression_check.py",
    CHECKS / "git_env_survivors_regression_check.py",
    CHECKS / "github_delivery_survivors_regression_check.py",
    CHECKS / "dart_decimate_gate_survivors_regression_check.py",
    HE / "execution_direct_survivors_regression.py",
    HE / "execution_direct_survivors2_regression.py",
    HE / "plan_cleanup_survivors_regression.py",
    HE / "plan_cleanup_survivors2_regression.py",
