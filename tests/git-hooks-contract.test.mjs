...
assert.ok(setupScript.includes('Hard Eng skills to link: all, none, or comma-separated names [all]:'), 'setup must ask for selected skills when interactive');
assert.ok(setupScript.includes('persist_skill_selection'), 'setup must persist selected skills before install');
