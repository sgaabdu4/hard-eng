...
const autoSyncText = read('scripts/auto-sync.sh');
...
const refreshAgentPathsText = read('scripts/refresh-no-mistakes-agent-paths.mjs');
...
assertIncludes(installText, 'refresh_no_mistakes_agent_paths');
