...
assertIncludes(readmeText, '| `no-mistakes-required` | The PR contains no-mistakes evidence from `sgaabdu4` before review or merge.');
...
assertIncludes(noMistakesRequiredText, 'No-mistakes Evidence');
assertIncludes(noMistakesRequiredText, 'select(.user.login ==');
