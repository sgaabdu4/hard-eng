...
[![Version](https://img.shields.io/badge/version-0.1.0--alpha.16-f59e0b)](#versioning)
...
Current version: `0.1.0-alpha.16` from [VERSION](VERSION). The matching Git tag is `v0.1.0-alpha.16`.
