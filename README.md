...
- `guardrailInventory.touchedStacks[]`: UI/component/API/schema/JS/TS/Flutter/Dart stack evidence used to fail closed on missing SSOT, Fallow, or duplicate/clone checks
