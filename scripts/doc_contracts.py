...
ANCHORS: dict[str, tuple[str, ...]] = {
    "AGENTS.md": (
        ...
        "unchanged state-changing steps/retries stay covered",
        "failure ends retry coverage",
        ...
        "read-only retry requires changed safe mechanism",
    ...
    "PRODUCT.md": (
        ...
        "paid/native/external attempts after one failure without fresh approval + changed proven mechanism",
