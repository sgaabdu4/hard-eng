...
ANCHORS: dict[str, tuple[str, ...]] = {
    ...
    "README.md": (
        ...
        "External, runtime, and platform assumptions are verified from current primary sources",
        "Paid or native retries wait for root cause",
    ...
    "PRODUCT.md": (
        ...
        "blind paid/native retries before root cause + compatible sentinel",
