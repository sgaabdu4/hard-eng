...
ANCHORS: dict[str, tuple[str, ...]] = {
    "AGENTS.md": (
        ...
        "Setup-first = checkout decision + worktree `write` + gate manifest + memory index",
        "lifecycle entry = wired during `he` feature setup",
    ...
    "README.md": (
        ...
        "Planning starts after a short cached feature setup",
    ...
    "PRODUCT.md": (
        ...
        "one Ready-to-build approval",
        "feature setup green",
        "approved before full-gate debt",
        "Implement ⇄ Verify",
    ...
    "skills/he/SKILL.md": (
        ...
        "Feature setup precedes planning",
        "`setup_state.py verify`",
    ),
    "skills/he-plan/SKILL.md": (
        ...
        "memory/path/image existence alone = invalid",
        "standalone HTML, invented combined screen, ImageGen page",
        "planning-only static data may be placed on that exact app screen",
    ...
    "skills/he-plan/references/feature-brief.md": (
        ...
        "Every affected screen/state = one reviewed delivery screenshot shown in chat",
    ...
    "skills/deterministic-checks/references/worktree.md": (
        "Feature Loop entry = `he` feature setup",
