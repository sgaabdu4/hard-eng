...
const generatedCredentialCleanupMisbindingPattern = /\b(?:deleted|removed|purged|revoked)\s+(?:ticket|issue|request|proof|evidence|note|artifact|case|(?:cleanup\s+)?record)\b/i;
