...
const approvalBoundarySideEffectPatterns = new Map([
  ['prod-backend-write', [
    ...
    ['prod-email', [
      /\b(?:sent|send|sending|emailed|emailing|messaged|messaging|delivered|deliver|delivering|notified|notify|notifying|invited|invite|inviting)\b.*\b(?:prod|production)\b.*\b(?:email|emails|receipt|receipts)\b/,
      /\b(?:sent|send|sending|emailed|emailing|messaged|messaging|delivered|deliver|delivering|notified|notify|notifying|invited|invite|inviting)\b.*\b(?:email|emails|receipt|receipts)\b.*\b(?:prod|production)\b/,
      /\b(?:prod|production)\b.*\b(?:email|emails|receipt|receipts)\b.*\b(?:sent|send|sending|emailed|emailing|messaged|messaging|delivered|deliver|delivering|notified|notify|notifying|invited|invite|inviting)\b/,
      /\b(?:email|emails|receipt|receipts)\b.*\b(?:sent|send|sending|emailed|emailing|messaged|messaging|delivered|deliver|delivering|notified|notify|notifying|invited|invite|inviting)\b.*\b(?:prod|production)\b/,
      /\b(?:email|emails|receipt|receipts)\b.*\b(?:prod|production)\b.*\b(?:sent|send|sending|emailed|emailing|messaged|messaging|delivered|deliver|delivering|notified|notify|notifying|invited|invite|inviting)\b/,
