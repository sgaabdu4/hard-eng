...
function hasStoredTextLikeValue(value) {
  if (Array.isArray(value)) return value.some(hasStoredTextLikeValue);
  if (isObject(value)) return Object.values(value).some(hasStoredTextLikeValue);
