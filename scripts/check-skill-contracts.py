...
STAGE_CHECK_PATHS = (ROOT / "skills/he-build/scripts/check.py", ROOT / "skills/he-ship/scripts/check.py", ROOT / "skills/e2e/scripts/visual_evidence_regression_check.py", ROOT / "skills/deterministic-checks/scripts/dart_decimate_gate_regression_check.py")
