...
const commands = [
  ...
  nodeFile('tests/he-state-implementation-ui-screenshots.test.mjs'),
  nodeFile('tests/he-state-live-currentness.test.mjs'),
  ...
  nodeFile('tests/no-mistakes-agent-paths.test.mjs'),
  nodeFile('tests/no-mistakes-review-comments.test.mjs'),
  nodeFile('tests/no-mistakes-required-workflow.test.mjs'),
  nodeFile('tests/no-mistakes-projects.test.mjs'),
  nodeFile('tests/no-mistakes-wrapper-preflight.test.mjs'),
  nodeFile('tests/no-mistakes-wrapper-refresh-behavior.test.mjs'),
  ...
  nodeFile('scripts/check-markdown-hygiene.mjs'),
  nodeFile('scripts/format-hard-eng.mjs', { args: ['--check', '.'] }),
  nodeFile('scripts/check-generated-assets.mjs', { args: ['.'] }),
  nodeFile('scripts/check-hard-eng-artifacts.mjs', { args: ['--head', '.'] }),
  nodeFile('scripts/check-hard-eng-write-safety.mjs', { args: ['--head', '.'] }),
  nodeFile('scripts/check-no-mistakes-projects.mjs', { args: ['--allow-missing-no-mistakes-remote', '.'] }),
