...
Result: Passed
E2E: Passed — Historical native shell install/update transactions and real scanner execution are recorded below; hosted activation and later delivery remain separate.
