...
try {
	...
	if (beforeDialog < 50)
		throw new Error("pointer was not visible before the native dialog opened");
	if (overDialog < 50)
		throw new Error("pointer disappeared behind the native dialog");
	console.log(
		`native-dialog-pointer-smoke: PASS before=${beforeDialog} modal=${overDialog}`,
	);
} finally {
