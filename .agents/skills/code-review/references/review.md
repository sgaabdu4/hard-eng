...
- Tests = determine whether assertions would detect the alleged failure; inspect doubles and the public boundary. Passing gates do not establish requirement coverage, realistic UI behavior or deployed success.
