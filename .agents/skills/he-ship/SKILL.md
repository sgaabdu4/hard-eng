...
- Baseline repair = [HE Plan's prerequisite route](../he-plan/SKILL.md#baseline-repair) requires its own delivery through verified main before feature work resumes. Finish the authorized Merge or Deploy target, including current remote CI; a PR-only handoff leaves the dependent feature blocked.
