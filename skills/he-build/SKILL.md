...
- Auditor input = deterministic bounded shards × two independent inventory passes + one lossless aggregate verdict; indivisible primary evidence overflow = fail closed.
