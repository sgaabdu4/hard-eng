...
- For any UI-touched work, capture actual implementation screenshots from the real route/surface before `/he:verify`; record them as a passed `implementation-ui-screenshots` guardrail with screenshot paths in evidence
