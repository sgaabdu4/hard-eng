...
- A material conflict or unanswered decision in a bound run records
  `clarification.required` and permits only the explicit user-answer event until
  the exact return boundary resumes.
