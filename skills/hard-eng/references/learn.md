...
Use deterministic fail-before/pass-after proof by default. Agent-behavior gaps
use the smallest route or skill fixture that reproduces the miss; a model-backed
evaluation requires an explicit user-approved call budget and is never launched
automatically.
