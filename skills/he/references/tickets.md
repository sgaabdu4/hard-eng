...
- The worktree `authorization.json` expires ~3600s; `claim --refresh` idempotently refreshes it in place. Refresh at any ticket checkpoint past expiry, and always before a publish attempt made >1h after the original claim.
