...
6. Map each acceptance criterion → ≥1 authoritative written flow; add Mermaid only when it clarifies branching.

## Complete

- Every in-scope actor + acceptance criterion maps to ≥1 flow.
- Main, alternate, failure, permission, recovery paths = explicit where possible.
