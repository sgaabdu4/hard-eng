...
- One cached plan preflight + streamed PASS per slice = recorded before acceptance; estimate never guarantees candidate admission and does not replace final audit.
