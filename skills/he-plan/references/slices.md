...
- One cached plan preflight + streamed PASS/review-shard count per slice = recorded before acceptance; estimate never guarantees candidate admission and does not replace final audit.
