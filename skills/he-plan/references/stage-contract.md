...
- When a source brief or specification exists, `PASS` requires deterministic,
  ...
  with concrete plan and evidence references that resolve to accepted plan
  artifacts and existing project-local evidence files. Missing sources, changed digests,
