...
Explore directly. Use subagents for independent areas only when the user
explicitly requests delegation, and verify their evidence before including it.
...
Walk the design tree with one targeted unresolved question at a time:
