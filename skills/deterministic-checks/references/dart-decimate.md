...
- Every gate → `python3 "$HOME/.agents/skills/deterministic-checks/scripts/dart_decimate_gate.py" --package <package-root>`.
- Runner = package/Git-root validation + `npx --yes dart-decimate@latest json <git-root>` + unchanged upstream exit.
