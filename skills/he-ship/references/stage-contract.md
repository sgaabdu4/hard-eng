...
- Put the actual reachable executable invocation in every named Ship guardrail `command`; comments, quoted or echoed command text, and statically unreachable `&&`/`||` branches are not command proof
