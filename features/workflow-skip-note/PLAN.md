...
Blockers: None
Handoff: Approval
Authority: The user asked for this note after the trial report, and to merge PR 137 first. The note goes to stderr because setup's `--plan` mode writes JSON to stdout. Merge awaits the user's go-ahead.
